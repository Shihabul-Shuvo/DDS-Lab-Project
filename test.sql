...
CREATE OR REPLACE PACKAGE BODY BorrowFromLibraryPackage AS
    ...
    BEGIN
        ...
        FROM Books
        WHERE Title = v_BorrowBookName;
		
		
        INSERT INTO Borrowers (Borrow_ID, Phone_No, Book_ID, Loan_Date, Return_Date)
        VALUES (v_total_borrowed, p_PhoneNo, v_borrow_BookID, p_LoanDate, p_ReturnDate);
        COMMIT;
